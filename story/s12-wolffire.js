...
export default class WolfFire {
  constructor() {
    ...
    this.img = new Image();
    this.img.src = 'img/S12.jpg';

    // 오디오 파일 불러오기 (src 임시) , .loop 자동반복 false로 막음
    this.audio = new Audio();
    this.audio2 = new Audio();
    this.audio.src = 'audio/sound/scene12.mp3';
    this.audio2.src = 'audio/sound/endingSound.mp3';

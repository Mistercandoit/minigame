// 클래스명 바꿔주기
import confettiInit from './confetti.js';
export default class Ending {
  constructor() {
    ...
    this.img = new Image();
    this.img.src = 'img/S13.jpg';

    // 오디오 파일 불러오기 (src 임시) , .loop 자동반복 false로 막음
    this.audio = new Audio();
    this.audio.src = 'audio/sound/scene13.mp3';
    ...
    this.subtitleTxt = [
      '그 뒤로 늑대는 두 번 다시 돼지 삼형제를 괴롭히지 않았어요. ',
      '그렇게 아기 돼지 삼형제는 행복하게 살았답니다.',
    ]; /*여기다가 멘트들 한줄씩 넣으면 됨*/

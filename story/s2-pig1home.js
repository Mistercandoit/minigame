...
export default class Pig1home {
  constructor() {
    ...
    this.strawImg = document.querySelector('#straw');
    ...
    this.img = new Image();
    this.img.src = '../img/S2.jpg';

    // 오디오 파일 불러오기 (src 임시) , .loop 자동반복 false로 막음
    this.audio = new Audio();
    this.audio.src = '../audio/sound/scene2.mp3';
    ...
    this.subtitleTxt = [
      '첫째 돼지는 게을렀어요.',
      '"어떻게 하면 쉽게 집을 지을 수 있을까?"',
      '첫째 돼지는 하루종일 놀다가 짚으로 후다닥 집을 짓고',
      '집에 들어가 편히 쉬었어요.',
    ]; /*여기다가 멘트들 한줄씩 넣으면 됨*/

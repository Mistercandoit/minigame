...
export default class Pig2home {
  constructor() {
    ...
    this.woodImg = document.querySelector('#wood');
    ...
    this.img = new Image();
    this.img.src = '../img/S3.jpg';

    // 오디오 파일 불러오기 (src 임시) , .loop 자동반복 false로 막음
    this.audio = new Audio();
    this.audio.src = '../audio/sound/scene3.mp3';
